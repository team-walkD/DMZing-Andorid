...
class MypageReviewActivity : AppCompatActivity(), View.OnClickListener, Utils {
    override fun init() {
        reviewBackBtn.setOnClickListener(this)
            ...
            override fun onResponse(
                ...
                when (response!!.code()) {
                    200 -> {
                        ...
                        mypageReviewAdapter.onReviewClickListener(this@MypageReviewActivity)
